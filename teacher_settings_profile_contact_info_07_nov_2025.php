...
<style>
  ...
  .la_card {
    ...
    padding: 14px;
    position: sticky;
    /* same feel as your first card if page scrolls */
    top: 80px;
    /* adjust to header height if needed */
...
<aside class="my_profile_about_right" style="border: 1px solid #E4E7EE; border-radius: 14px; margin-top: -85px;">
  <!-- ===== Right Card #1: Header + Contact Info ===== -->
  <div class="rpanel_card my_profile_about_card_shadow">
    <!-- Header -->
