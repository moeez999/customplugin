  ...
  <div class="calendar_admin_main_wrapper">
      ...
      <aside class="calendar_admin_sidebar">
          <button class="calendar_admin_btn calendar_admin_btn_active"
              id="calendar_admin_details_create_cohort_open">Create Cohort</button>
          ...
          <div class="calendar_admin_tags_section">
              ...
              <ul class="calendar_admin_tags_list">
                  ...
                  <li><span class="calendar_admin_tag_icon calendar_admin_tag_conversation"></span>Conversational Class
                  </li>
              ...
              <ul class="calendar_admin_status_list">
                  <li><span class="calendar_admin_status_icon calendar_admin_status_icon_confirmed"></span>Confirmed by
                      the student</li>
                  <li><span class="calendar_admin_status_icon calendar_admin_status_icon_not_confirmed"></span>Not
                      confirmed by the student</li>
                  <li><img src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1F501.svg"
                          style="width:14px;margin-right:6px;vertical-align:middle;">Weekly Class</li>
                  <li><img src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/svg/1F4C5.svg"
                          style="width:14px;margin-right:6px;vertical-align:middle;">Single class</li>
              </ul>
          </div>
      </aside>
      ...
      <main class="calendar_admin_calendar_outer">
          ...
          <div class="calendar_admin_calendar_header">
              ...
              <button class="calendar_arrow_btn" id="prev-week">
                  <svg width="20" height="20" viewBox="0 0 24 24">
                      <polyline points="15 19 8 12 15 5" fill="none" stroke="#222" stroke-width="2"
                          stroke-linecap="round" stroke-linejoin="round" />
                  </svg>
              </button>
              <button class="calendar_arrow_btn" id="next-week">
                  <svg width="20" height="20" viewBox="0 0 24 24">
                      <polyline points="9 5 16 12 9 19" fill="none" stroke="#222" stroke-width="2"
                          stroke-linecap="round" stroke-linejoin="round" />
                  </svg>
              </button>
              ...
              <div class="calendar_admin_header_section">
                      ...
                      <div class="dropdown-menu profile-menu" id="profile-dropdown">
                          <div class="profile-dropdown-list">
                              <div class="profile-option">
                                  <div class="profile-option-header"><img
                                          src="https://randomuser.me/api/portraits/men/32.jpg"> Edwards</div>
                              </div>
                              <div class="profile-option">
                                  <div class="profile-option-header"><img
                                          src="https://randomuser.me/api/portraits/women/15.jpg"> Daniela</div>
                              </div>
                              <div class="profile-option">
                                  <div class="profile-option-header"><img
                                          src="https://randomuser.me/api/portraits/men/15.jpg"> Hawkins</div>
                              </div>
                              <div class="profile-option">
                                  <div class="profile-option-header"><img
                                          src="https://randomuser.me/api/portraits/men/45.jpg"> Warren</div>
                              </div>
                          </div>
                      </div>
                  </div>
                  ...
                  <div class="mb-3">
                      <button class="calendar_admin_menu_btn calendar_admin_menu_btn_active"
                          id="calendar_admin_semana_btn">
                          Semana
                      </button>
                      <button class="calendar_admin_menu_btn" id="calendar_admin_agenda_btn"
          ...
          <head>
              ...
              :root {
                  ...
                  /* 30-minute grid */
                  --slot-h: 36px;
                  /* height of each 30 min slot */
                  --rows: 34;
                  /* set by JS: (end-start)*2 */
              ...
              * {
              ...
              .day-inner {
                  position: relative;
                  height: calc(var(--rows) * var(--slot-h));
              }
              ...
              .day-inner .slots {
                  ...
                  z-index: 0;
                  display: grid;
                  grid-template-rows: repeat(var(--rows), var(--slot-h));
              }
              ...
              .day-inner .slots>div:first-child {
                  border-top-color: var(--hour-line);
              }

              /* 7:00 */
              .day-inner .slots>div:nth-child(2n+1) {
                  border-top-color: var(--hour-line);
              }
              ...
              @media (max-width:700px) {
                  ...
                  .cal-head,
                  .grid {
                      grid-template-columns: 70px repeat(7, 320px)
                  }
              }
              </style>
          </head>
          ...
          <body>
              ...
              const STACK_OFFSET = parseInt(getComputedStyle(document.documentElement).getPropertyValue(
                  '--stack-offset')) || 18;
              const STACK_CAP = parseInt(getComputedStyle(document.documentElement).getPropertyValue('--stack-cap')) ||
                  3;
