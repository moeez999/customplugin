...
<body class="my_profile_about_root bg-white text-[color:var(--my_profile_about_text)]">
        ...
        <div class="my_profile_about_layout grid gap-10">
            ...
            <main class="space-y-8">
                <section id="my_profile_about_tab_about" class="my_profile_about_tabpanel">
                    ...
                    <p class="my_profile_about_helper mt-3 max-w-[680px]">Start creating your public tutor profile. Your progress will be automatically saved as you complete each section.</p>
                    ...
                    <form class="mt-7 space-y-6" onsubmit="return false;">
                        ...
                        <div>
                            ...
                            <div class="my_profile_about_dropdown_wrap" id="my_profile_about_country_wrap" data-open="false">
                                <div class="my_profile_about_field my_profile_about_dropdown_display w-full" id="my_profile_about_country_display" role="combobox" aria-expanded="false" aria-controls="my_profile_about_country_panel" tabindex="0">
                        ...
                        <div>
                            ...
                            <div class="my_profile_about_dropdown_wrap" id="my_profile_about_tz_wrap" data-open="false">
                                <div class="my_profile_about_field my_profile_about_dropdown_display w-full" id="my_profile_about_tz_display" role="combobox" aria-expanded="false" aria-controls="my_profile_about_tz_panel" tabindex="0">
                        ...
                        <!-- ===== Languages (custom dropdowns for Language + Level) ===== -->
                        <div>
                ...
                <!-- ===== keep your PHP includes (tabs will toggle these panels) ===== -->
            ...
            <aside class="my_profile_about_right sticky top-8">
                <div class="my_profile_about_card my_profile_about_card_shadow rounded-2xl border border-[color:var(--my_profile_about_border)] p-4">
                    <div class="flex items-start gap-3">
                        <img src="https://images.unsplash.com/photo-1544005313-94ddf0286df2?q=80&w=128&auto=format&fit=crop" alt="Avatar" class="w-10 h-10 rounded-full object-cover">
                        <div class="min-w-0">
                            <div class="flex items-center gap-2">
                                ...
                                <svg width="16" height="16" viewBox="0 0 24 24" fill="#2563EB" aria-hidden="true">
                                    <path d="M12 2l2.39 2.39 3.38-.46-.46 3.38L20 10l-2.69 1.69.46 3.38-3.38-.46L12 18l-2.39-2.39-3.38.46.46-3.38L4 10l2.69-1.69-.46-3.38 3.38.46L12 2z"></path>
                                    <path d="M10.4 12.3l-1.7-1.7-1.1 1.1 2.8 2.8 5-5-1.1-1.1-3.9 3.9z" fill="#fff"></path>
                                </svg>
                            </div>
                    ...
                    <div class="mt-4 space-y-2.5">
                        ...
                        <button class="my_profile_about_btn w-full flex items-center justify-center gap-2 bg-white">
                            <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
                                <path d="M2 12s4-7 10-7 10 7 10 7-4 7-10 7-10-7-10-7z" stroke="#111827" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" />
                                <circle cx="12" cy="12" r="3" stroke="#111827" stroke-width="1.6" />
                            </svg>
                            <a href="my_lessons_tutor_profile.php"><span class="font-medium text-[.98rem]">Preview profile</span></a>
                        </button>


                        <button class="my_profile_about_btn w-full flex items-center justify-center gap-2 bg-white" id="my_profile_share_profile_modal_openBtn">
                            <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
                                <path d="M4 12v7a1 1 0 001 1h14a1 1 0 001-1v-7" stroke="#111827" stroke-width="1.6" stroke-linecap="round" />
                                <path d="M16 6l-4-4-4 4" stroke="#111827" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" />
    ...
    <?php require_once('my_profile_share_profile_modal.php'); ?>

    <script>
        /* ===========================
       TABS: click + hash restore
       =========================== */
        ...
        function my_profile_about_bindTabs() {
            ...
            // initial tab from hash or default 'about'
        ...
        /* ===== country dataset + flags (also used for phone list) ===== */
        ...
        function my_profile_about_buildCountryList(list, filter = '') {
            ...
            const q = norm(filter);
            const res = my_profile_about_countries.filter(c => norm(c.name).includes(q)).sort((a, b) => a.name.localeCompare(b.name));
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4" data-row="${rowId}">
        ...
        $(function() {
            ...
            $('#my_profile_about_country_display').on('click', () => my_profile_about_openCountryPanel($('#my_profile_about_country_wrap').attr('data-open') !== 'true'))
                .on('keydown', e => {
            ...
            $('#my_profile_about_tz_display').on('click', () => my_profile_about_openTzPanel($('#my_profile_about_tz_wrap').attr('data-open') !== 'true'))
                .on('keydown', e => {
                    if (['Enter', ' '].includes(e.key)) {
                        e.preventDefault();
            ...
            // Phone
            $('#my_profile_about_phone_flag').html(my_profile_about_flagSVG('VEN')); // default
            my_profile_about_buildPhoneList('');
            $('#my_profile_about_phone_prefix').on('click', () => my_profile_about_openPhonePanel($('#my_profile_about_phone_panel').is(':hidden')))
                .on('keydown', e => {
                    if (['Enter', ' '].includes(e.key)) {
                        e.preventDefault();
            ...
            // Close on outside click / Esc for all dropdowns
