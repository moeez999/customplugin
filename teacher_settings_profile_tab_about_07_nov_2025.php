...
<head>
    ...
    <style>
        ...
        /* Collapsed — keep same grid; hide left + center only */
        .my_profile_about_layout.collapsed {
            grid-template-columns: 220px 1fr 300px;
        }

        .my_profile_about_layout.collapsed .my_profile_about_left,
        .my_profile_about_layout.collapsed .my_profile_about_center {
            opacity: 0;
            visibility: hidden;
            pointer-events: none;
        }
...
<body class="my_profile_about_root bg-white text-[color:var(--my_profile_about_text)]">
    <div class="mx-auto px-4 md:px-6 lg:px-8 py-8">
        ...
        <div class="my_profile_about_layout grid gap-10" id="my_profile_about_grid">
            <!-- LEFT -->
            ...
            <!-- CENTER -->
            <main id="my_profile_about_center" class="my_profile_about_center space-y-8" style="width:70%;">
            ...
            <!-- RIGHT: included as a separate, self-contained file -->
