...
<head>
    ...
    * {
    ...
    .agenda-sidebar .sidebar-link:active {
        background: #eaeaea;
    }

    .agenda-sidebar .sidebar-link:last-child {
        margin-bottom: 0;
    }
    ...
    .agenda-header-bar .arrow-btn:active {
        background: #eee;
    }
    ...
    .agenda-header-bar .dropdown-menu,
    .agenda-header-bar .profile-menu {
        display: none;
        position: absolute;
        left: 0;
        top: 110%;
    ...
    .agenda-header-bar .today-btn:active {
        background: #eee;
    }
...
<body>
    <div class="agenda-container">
        ...
        <section class="agenda-main">
            ...
            <div class="agenda-header-bar">
                ...
                <!-- Cohorts Dropdown -->
                <div class="dropdown">
                    <div class="dropdown-toggle" id="cohortsDropdownBtn">Cohorts <i class="fa fa-chevron-down"
                            style="margin-left:9px;font-size:14px;"></i></div>
    ...
    const agendaData = [{
            ...
            day: 'Mon',
            time: '18:30 - 19:30',
            event: "Latingles - Teachers' Team Meeting"
        },
        {
            date: '3',
            day: 'Tue',
