...
<body>
  ...
  <main class="one_and_one_class_container">
    ...
    <!-- STUDENTS -->
    <section class="one_and_one_class_section" style="margin-top:40px;">
      <div class="one_and_one_class_sectionhead">
        <h2>Search 1:1 Sessions by Student</h2>
        <button id="one_and_one_class_toggle_students" class="one_and_one_class_chev" aria-expanded="true" title="Collapse/Expand">
          <svg viewBox="0 0 24 24" fill="none">
            <path d="M6 15l6-6 6 6" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
          </svg>
        </button>
      ...
      <div id="one_and_one_class_row_students" class="one_and_one_class_scroller">
        <!-- Select student -->
        <div class="one_and_one_class_card one_and_one_class_card--select">
          <div class="one_and_one_class_avatar_placeholder">
            <svg viewBox="0 0 24 24">
              <path d="M16 11c1.657 0 3-1.79 3-4s-1.343-4-3-4-3 1.79-3 4 1.343 4 3 4zM8 11c1.657 0 3-1.79 3-4S9.657 3 8 3 5 4.79 5 7s1.343 4 3 4zM8 13c-3.866 0-7 1.79-7 4v3h10v-3c0-2.21-3.134-4-7-4zm8 0c-.736 0-1.437.08-2.09.224C15.702 14.13 17 15.45 17 17v3h7v-3c0-2.21-3.134-4-7-4z" />
            </svg>
          </div>

          <button id="one_and_one_class_select_student_btn" class="one_and_one_class_btn">
            <span id="one_and_one_class_select_student_label">Select student</span>
            <svg viewBox="0 0 24 24" fill="none">
              <path d="M6 9l6 6 6-6" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
            </svg>
          </button>
    ...
    <section style="margin-top:24px;">
      <h3 style="font-size:20px; font-weight:700; margin:0 0 8px 0;">Active Students</h3>

          <?php require_once('one_and_one_class_active_students.php');?>


      <!-- <div class="one_and_one_class_panel">
        Maria’s Progress and 1:1 Session History
        <div style="height:48px; margin-top:16px; border:1px solid var(--one_and_one_class_border); border-radius:12px; background:var(--one_and_one_class_soft); display:grid; place-items:center; color:var(--one_and_one_class_muted);">
          Placeholder for your history widget
        </div>
      </div> -->
    </section>
